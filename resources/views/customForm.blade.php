    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="{{route('main')}}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
                <li class="active open"><a href="{{route('test.form.submit')}}"><i class="zmdi zmdi-home"></i><span>Custom Form submit</span></a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>My custom form</strong> Submit test</h2>
                            ...
                            <div class="body">
                                <p>Fill out members details below</p>
                                <form action="{{route('test.form.submit')}}" method="POST">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-3 col-md-6 mb-3">
                                            ...
                                            <select name="Gender" class="form-control show-tick ms select2" data-placeholder="Select">
                                                <option></option>
